...
//		        	}
	    ...
	    var twoTbar=new Ext.Toolbar({
	    	  items:[ '-',{
					...
					if(!confirm('确定要新增随访计划?'))return;
						App.util.addNewMainTab('/module/plan/addPlanItem.html?pid='+_paId + "&KID=" + KID,'增加随访计划');
					}
				}
	    	]
	    });
    ...
    var editGrid = new Ext.grid.EditorGridPanel({
		...
		viewConfig:{
		 ...
		 tbar: ['-','<font color="blue">随访设置日期</font>：', '<font color="red"><input type="text" size="12" name="itemBegin" readOnly=true></font>',
