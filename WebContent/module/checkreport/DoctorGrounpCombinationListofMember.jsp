		...
		'-', {
            ...
            handler: function(){
				...
				if(ss.length==0){
               	...
               	window.open('../InHospitalCase/Liver/CheckReport/inputCombinationList.html?patientId='+ss[0].get('patientId')+'&doctorName='+top.USER.name+"&doctorOrPatient=1", '', 'width=240px;');
            }		
		},
		'-', new SearchButton({
                        handler: function(){
