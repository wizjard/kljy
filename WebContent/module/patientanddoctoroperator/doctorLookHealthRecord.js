				...
				items:[
					{
						...
						dataUrl:doctorBaseUtil+'?method=doctorHealthRecord_treeNodesDoctorOnly&patientId='+PID,
						root:{
							nodeType:'async',
							text:'字典树',
							draggable:false,
					...
					,
					{
						...
						autoScroll:true,
						containerScroll:true,
						dataUrl:baseUrl+'?method=patientHealthRecord_treeNodesDoctorOnly&patientId='+PID,
						root:{
							nodeType:'async',
							text:'字典树',
							draggable:false,
...
function createMainHtml(){
	...
	Ext.Ajax.request({
		url:baseUrl,
			params:{
				method:'findPatientHealthRecordByPatientIdDoctorOnly',
					...
					if(data != undefined){
						...
						if(data.length ==0){
							...
							if(data[i].uploadFile !="" && data[i].uploadFile != null){	
								...
								+'</tr><tr><td class="titletd" style="background-color: #f5f5f5; padding:3px;" colspan="4"><font size="2">目前状况</font></td></tr></table><table width="600" border=0 cellspacing=0 borderColorDark=#ffffff cellpadding=0>'
								+'<tr>'
								...
								+'</tr>'
								+'<tr><td class="titletd" colspan="3" style="background-color: #f5f5f5; padding:3px;"><font size="2">健康情况</font></td></tr>'
								...
								+'<tr><td class="titletd" colspan="3" style="background-color: #f5f5f5; padding:3px;"><font size="2">治疗情况<font></td></tr>'
								...
								+'<tr><td class="titletd" colspan="3" style="background-color: #f5f5f5; padding:3px;"><font size="2">病情转归<font></td></tr>'
