	...
	var tpl = new Ext.XTemplate(
		...
		'<div class="data-item"><div>',
			'<table width="100%" border=0 cellpadding=0 cellspacing=2 name="table{id}">',
				'<tr>',
					'<td class="index"><b>&nbsp;&nbsp;第{orderNo}门诊</b></td>',
					'<td class="title" style="width:48%;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<select {readonly} name="outTitle" value="{outTitle}" onchange="TitleChange(this)" style="width:200px;"></select></td>',
					'<td >门诊时间：<input type="text" name="outWriteTime" readonly="readonly" value="{outWriteTime}" style="width:100px" onchange="TimeChange(this)"/><img {readonly} src="../../PUBLIC/images/calendar.bmp" style="cursor:pointer" onclick="ShowTimePicker(this)"/>',
					'</td>',
				'</tr>',
				'<tr>',
			...
			'<tr><td colspan="2" style="padding-left:5px"><a href="###" onclick="displayOrNone(this)"><input type="hidden" name="suiFangFlag" value="{suiFangFlag}" /><font color="red"><B>设置下次随访</B></font></a></td></tr>',
			...
			'<tr><td></td><td style="padding-left:260px">',
				...
				tbar:[
					...
					'->',{
						text:'返回',handler:function(){
							location.href=App.App_Info.BasePath+'/module/biomedical/member/ctx/memberOutCaseList.html';
						}
					},'&nbsp;&nbsp;'
				],
