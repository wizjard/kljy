...
function createDateView(){
	...
	var innerContentAll ='<div class="yygh">'
					...
					+'</td></tr></table><br/>' 
	+'<table cellpadding="0" cellspacing="0" width="100%" class="tylb">'
	+'<tr class="blue"><td width="10%" class="jclb">医生</td><td width="10%" class="jclb">职称</td>'+innerContent
	+'</table>';
...
function openNewFourDays(){
	window.location.href = ('appointmentRegistration14.html?deptName='+deptName+'&deptCode='+deptCode);
}
