...
//alert(App.util.getHtmlParameters('account'));
	var loader = new Ext.tree.TreeLoader({
			            dataUrl: App.App_Info.BasePath+'/GradingDiagAction.do?method=getGradingsOut&PID='+App.util.getHtmlParameters('PID')
...
function refreshNode(id){
		Ext.get('iframe').dom.src='register4.html?id='+id;
