...
<table class="conTable" border=0 cellpadding=0 cellspacing=0>
	<tr>
			<td class="td2" width="50%" colspan="2"><b>确定诊断：</b>日期：<span name="queding_diagnosis_time">&nbsp;</span></td>
			...
			<td class="td2" width="50%" colspan="2"><b>初步诊断：</b>日期：<span name="chubu_diagnosis_time">&nbsp;</span></td>
	</tr>
	<tr>
		<td colspan="2" rowspan="3" class="td2" name="queding_diagnosis">&nbsp;</td>
		<td colspan="2" class="hidden td2">辩病：<span name="chubu_bianbing"></span></td>	
	</tr>
	<tr class="hidden">
		<td colspan="2" class="td2">治则与方药：<span name="chubu_zhizefangyao"></span></td>
	</tr>
	<tr>
