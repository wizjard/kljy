...
<div id="page-con">
	<div style="border-bottom:solid 1px #000;margin-bottom:10px;">确定诊断续打若有错行:输入向下行偏移量后点续打(如需下移1行请输"1"):<input id="rowOffset" type="text" value="" size=1 /><input onclick="testDiag()" type="button" value="确定诊断续打" /></div>
