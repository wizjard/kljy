...
function layout(){
	...
	if(patientId != null && top.USER == undefined&& guanliyuan !=1){
		...
		guidangList = [["","--请选择--"],["是","是"]];
	    ds.baseParams = {
	        method: 'getMyGrounpCheckReportsForByMemberMaiDi',
	        search: '',
	        patientId:patientId
    	}; 
		 ...
		 ds.baseParams = {
	        method: 'getMyGrounpCheckReportsForByMemberDoctorMaiDi',
	        search: '',
	        patientId:patientId
    	}; 
	}else if(patientId != null && top.USER != undefined&& guanliyuan ==1){
		 ...
		 guidangList = [["","--请选择--"],["是","是"],["否","否"]];
		 ds.baseParams = {
	        method: 'getMyGrounpCheckReportsForByMemberGuanLiYuanMaiDi',
	        search: '',
	        patientId:patientId
    	}; 
	}
...
function openCheck(id,isPatientOrDoctorWriteZanCun,isFromOutHispital,pId,checkItem){
		...
		if(isFromOutHispital == 1){
			if(guanliyuan == 1){
				window.location ='updateLabExaminationMaiDi.html' + params+'&guanliyuan=1';	
			}else{
