...
function createGrid(){
	...
	var _cm_normal=[
		...
		{header:'门诊卡号',dataIndex:'patientNo'},
	...
	var _baseParams={method:'queryAll',patientType:1};//加载门急诊病人信息列表
	if(_cfg){
		...
		tbar:[
			...
			'-',{
				text:'新增',handler:function(){
					App.util.addNewMainTab('/module/outPatientOrEmergencyService/OutOrEmergencyPatientInfo.html','新增门诊病人');
				}
			},'-',{
				text:'编辑'
			},'-',{
