...
//			}
//		}},
//		{header:'随访项目',dataIndex:'planItems',renderer:function(value){
//			//alert(planItems);
//			return value;
//		}},
...
//		{header:'关联随访计划次数',dataIndex:'outFollowTimes',renderer:function(value, meta, record, rowIndex, colIndex, store){
...
//		{header:'预约日期',dataIndex:'outReserveDate'},
		...
		{header:'门诊记录医生',dataIndex:'outMainDoctor'}
	]);
