...
var PatientID=App.util.getHtmlParameters('pid')//课题id
 ...
 */
function addNode(){
	document.getElementById("courseRecord").src="srRegister.html?id=-1&rid="+rid+"&patientID="+PatientID+"&add=add"+"&random="+new Date().getTime()+"&courseId="+courseId+"&timesText="+timesText;
}
/*
 *删除树节点
 */
...
function getCourseID(){
    $.post(App.App_Info.BasePath+'/EMR/register.do',{method:'getCourseID',
									id:rid},
									function(data){
									courseId=data.data;
									},'json'
