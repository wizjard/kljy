...
public class CopyDataImplforRemoteofJava{
...
//				statement_toRemote.setInt(2, i * P_N);
				sqlForSelect = "select top " + P_N + " * from ##tempReportForm where id not " +
					"in (select top " + i * P_N + " id from ##tempReportForm order by id) order by id";
				statement_toRemote = con_toRemote.prepareStatement(sqlForSelect);
	...
	public static void main(String[] args){
		try {
			Date originalDate = java.text.DateFormat.getDateInstance().parse("2008-01-01");
			
			int interval = -27;
			String dateFrom = "2008-05-01";
			String dateEnd = "2008-06-01";						
			...
			CopyDataImplforRemoteofJava cd = new CopyDataImplforRemoteofJava();
			
			while(originalDate.getTime() < dateE.getTime()){
