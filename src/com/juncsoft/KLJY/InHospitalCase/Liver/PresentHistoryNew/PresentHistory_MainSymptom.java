...
public class PresentHistory_MainSymptom {
	...
	private PresentIllnessHistoryN preIllHis;
	...
	public void setDabian_color(String dabian_color) {
		this.dabian_color = dabian_color;
	}
	public String getDabian_countDay() {
		return dabian_countDay;
	}
	public void setDabian_countDay(String dabian_countDay) {
		this.dabian_countDay = dabian_countDay;
	}
	public String getDabian_countTotal() {
		return dabian_countTotal;
	}
	public void setDabian_countTotal(String dabian_countTotal) {
		this.dabian_countTotal = dabian_countTotal;
	}
	public String getDabian_huibai() {
		return dabian_huibai;
	}
	public void setDabian_huibai(String dabian_huibai) {
		this.dabian_huibai = dabian_huibai;
	}
	public String getDabian_shape() {
		return dabian_shape;
	}
	public void setDabian_shape(String dabian_shape) {
		this.dabian_shape = dabian_shape;
	}
	public String getDabian_side() {
		return dabian_side;
	}
	public void setDabian_side(String dabian_side) {
		this.dabian_side = dabian_side;
	}
	public String getDabian_volumeDay() {
		return dabian_volumeDay;
	}
	public void setDabian_volumeDay(String dabian_volumeDay) {
		this.dabian_volumeDay = dabian_volumeDay;
	}
	public String getDabian_volumeTotal() {
		return dabian_volumeTotal;
	}
	public void setDabian_volumeTotal(String dabian_volumeTotal) {
		this.dabian_volumeTotal = dabian_volumeTotal;
	}
	public String getDabian_xue() {
		return dabian_xue;
	}
	public void setDabian_xue(String dabian_xue) {
		this.dabian_xue = dabian_xue;
	}
	...
	public void setFali_performance(String fali_performance) {
		this.fali_performance = fali_performance;
	}
	...
	public void setFansuan_time(String fansuan_time) {
		this.fansuan_time = fansuan_time;
	}
	...
	public void setFare_performance(String fare_performance) {
		this.fare_performance = fare_performance;
	}
	public String getFare_side() {
		return fare_side;
	}
	public void setFare_side(String fare_side) {
		this.fare_side = fare_side;
	}
	public String getFare_tiwen() {
		return fare_tiwen;
	}
	public void setFare_tiwen(String fare_tiwen) {
		this.fare_tiwen = fare_tiwen;
	}
	public String getFare_topt() {
		return fare_topt;
	}
	public void setFare_topt(String fare_topt) {
		this.fare_topt = fare_topt;
	}
	...
	public void setFutong_cases(String futong_cases) {
		this.futong_cases = futong_cases;
	}
	public String getFutong_change() {
		return futong_change;
	}
	public void setFutong_change(String futong_change) {
		this.futong_change = futong_change;
	}
	public String getFutong_degree() {
		return futong_degree;
	}
	public void setFutong_degree(String futong_degree) {
		this.futong_degree = futong_degree;
	}
	public String getFutong_fangshe() {
		return futong_fangshe;
	}
	public void setFutong_fangshe(String futong_fangshe) {
		this.futong_fangshe = futong_fangshe;
	}
	public String getFutong_fangshe0() {
		return futong_fangshe0;
	}
	public void setFutong_fangshe0(String futong_fangshe0) {
		this.futong_fangshe0 = futong_fangshe0;
	}
	public String getFutong_performance() {
		return futong_performance;
	}
	public void setFutong_performance(String futong_performance) {
		this.futong_performance = futong_performance;
	}
	public String getFutong_position() {
		return futong_position;
	}
	public void setFutong_position(String futong_position) {
		this.futong_position = futong_position;
	}
	public String getFutong_position2() {
		return futong_position2;
	}
	public void setFutong_position2(String futong_position2) {
		this.futong_position2 = futong_position2;
	}
	public String getFutong_rate() {
		return futong_rate;
	}
	public void setFutong_rate(String futong_rate) {
		this.futong_rate = futong_rate;
	}
	public String getFutong_time() {
		return futong_time;
	}
	public void setFutong_time(String futong_time) {
		this.futong_time = futong_time;
	}
	...
	public void setFuxie_countDay(String fuxie_countDay) {
		this.fuxie_countDay = fuxie_countDay;
	}
	public String getFuxie_liji() {
		return fuxie_liji;
	}
	public void setFuxie_liji(String fuxie_liji) {
		this.fuxie_liji = fuxie_liji;
	}
	public String getFuxie_shape() {
		return fuxie_shape;
	}
	public void setFuxie_shape(String fuxie_shape) {
		this.fuxie_shape = fuxie_shape;
	}
	public String getFuxie_volumeDay() {
		return fuxie_volumeDay;
	}
	public void setFuxie_volumeDay(String fuxie_volumeDay) {
		this.fuxie_volumeDay = fuxie_volumeDay;
	}
	...
	public void setHuangran_degree(String huangran_degree) {
		this.huangran_degree = huangran_degree;
	}
	public String getHuangran_noside() {
		return huangran_noside;
	}
	public void setHuangran_noside(String huangran_noside) {
		this.huangran_noside = huangran_noside;
	}
	public String getHuangran_performance() {
		return huangran_performance;
	}
	public void setHuangran_performance(String huangran_performance) {
		this.huangran_performance = huangran_performance;
	}
	public String getHuangran_side() {
		return huangran_side;
	}
	public void setHuangran_side(String huangran_side) {
		this.huangran_side = huangran_side;
	}
	public Long getId() {
		return id;
	}
	...
	public void setNiaoye_qldegree(String niaoye_qldegree) {
		this.niaoye_qldegree = niaoye_qldegree;
	}
	public String getNiaoye_volume() {
		return niaoye_volume;
	}
	public void setNiaoye_volume(String niaoye_volume) {
		this.niaoye_volume = niaoye_volume;
	}
	public String getNiaoye_volumeTotal() {
		return niaoye_volumeTotal;
	}
	public void setNiaoye_volumeTotal(String niaoye_volumeTotal) {
		this.niaoye_volumeTotal = niaoye_volumeTotal;
	}
	...
	public void setOutu_countDay(String outu_countDay) {
		this.outu_countDay = outu_countDay;
	}
	public String getOutu_countTotal() {
		return outu_countTotal;
	}
	public void setOutu_countTotal(String outu_countTotal) {
		this.outu_countTotal = outu_countTotal;
	}
	public String getOutu_shape() {
		return outu_shape;
	}
	public void setOutu_shape(String outu_shape) {
		this.outu_shape = outu_shape;
	}
	public String getOutu_thing() {
		return outu_thing;
	}
	public void setOutu_thing(String outu_thing) {
		this.outu_thing = outu_thing;
	}
	public String getOutu_volumeTotal() {
		return outu_volumeTotal;
	}
	public void setOutu_volumeTotal(String outu_volumeTotal) {
		this.outu_volumeTotal = outu_volumeTotal;
	}
	...
	public void setOuxue_countDay(String ouxue_countDay) {
		this.ouxue_countDay = ouxue_countDay;
	}
	public String getOuxue_countTotal() {
		return ouxue_countTotal;
	}
	public void setOuxue_countTotal(String ouxue_countTotal) {
		this.ouxue_countTotal = ouxue_countTotal;
	}
	public String getOuxue_shape() {
		return ouxue_shape;
	}
	public void setOuxue_shape(String ouxue_shape) {
		this.ouxue_shape = ouxue_shape;
	}
	public String getOuxue_side() {
		return ouxue_side;
	}
	public void setOuxue_side(String ouxue_side) {
		this.ouxue_side = ouxue_side;
	}
	public String getOuxue_volumeDay() {
		return ouxue_volumeDay;
	}
	public void setOuxue_volumeDay(String ouxue_volumeDay) {
		this.ouxue_volumeDay = ouxue_volumeDay;
	}
	public String getOuxue_volumeTotal() {
		return ouxue_volumeTotal;
	}
	public void setOuxue_volumeTotal(String ouxue_volumeTotal) {
		this.ouxue_volumeTotal = ouxue_volumeTotal;
	}
	public PresentIllnessHistoryN getPreIllHis() {
		return preIllHis;
	}
	public void setPreIllHis(PresentIllnessHistoryN preIllHis) {
		this.preIllHis = preIllHis;
	}
	...
	public void setShenzhi_answer(String shenzhi_answer) {
		this.shenzhi_answer = shenzhi_answer;
	}
	public String getShenzhi_performance() {
		return shenzhi_performance;
	}
	public void setShenzhi_performance(String shenzhi_performance) {
		this.shenzhi_performance = shenzhi_performance;
	}
	...
	public void setShishao_performance(String shishao_performance) {
		this.shishao_performance = shishao_performance;
	}
	public String getShishao_reduce() {
		return shishao_reduce;
	}
	public void setShishao_reduce(String shishao_reduce) {
		this.shishao_reduce = shishao_reduce;
	}
	...
	public void setShuizhong_buwei(String shuizhong_buwei) {
		this.shuizhong_buwei = shuizhong_buwei;
	}
	public String getShuizhong_chengdu() {
		return shuizhong_chengdu;
	}
	public void setShuizhong_chengdu(String shuizhong_chengdu) {
		this.shuizhong_chengdu = shuizhong_chengdu;
	}
	public String getShuizhong_xingzhi() {
		return shuizhong_xingzhi;
	}
	public void setShuizhong_xingzhi(String shuizhong_xingzhi) {
		this.shuizhong_xingzhi = shuizhong_xingzhi;
	}
	...
	public void setXingwei_performance(String xingwei_performance) {
		this.xingwei_performance = xingwei_performance;
	}
