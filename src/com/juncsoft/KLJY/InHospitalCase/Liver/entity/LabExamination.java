...
public class LabExamination {
	...
	private String lab_otherDesc;
	private String niaosu_other;
	private String niaosu_otherDesc;

	/*----08-30----*/
	private String check_danwei;
	private String check_danwei0;
	
	/*========09-05========*/
	private Integer auxi_check = -1;
	...
	public String getLab_otherDesc() {
		return lab_otherDesc;
	}
	public void setLab_otherDesc(String lab_otherDesc) {
		this.lab_otherDesc = lab_otherDesc;
	}
	public String getNiaosu_otherDesc() {
		return niaosu_otherDesc;
	}
	public void setNiaosu_otherDesc(String niaosu_otherDesc) {
		this.niaosu_otherDesc = niaosu_otherDesc;
	}
	...
	public String getNiaosu_other() {
		return niaosu_other;
	}
	public void setNiaosu_other(String niaosu_other) {
		this.niaosu_other = niaosu_other;
	}
	...
	public String getCheck_danwei0() {
		return check_danwei0;
	}
	public void setCheck_danwei0(String check_danwei0) {
		this.check_danwei0 = check_danwei0;
	}

	public Integer getAuxi_check() {
		return auxi_check;
	}

	public void setAuxi_check(Integer auxi_check) {
		this.auxi_check = auxi_check;
	}
}
