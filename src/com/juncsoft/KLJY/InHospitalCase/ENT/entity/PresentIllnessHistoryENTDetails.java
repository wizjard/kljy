 ...
 *现病史多次组合内容
 */
public class PresentIllnessHistoryENTDetails {
	private Long id;//主键
	private PresentIllnessHistoryENT pi;//现病史
	...
	public PresentIllnessHistoryENT getPi() {
		return pi;
	}
	public void setPi(PresentIllnessHistoryENT pi) {
		this.pi = pi;
	}
