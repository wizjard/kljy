 ...
 * 
 */
public class LiverPhysicalExaminationPDF {
	public void getContent(PdfPTable tableContent, Font fontGeneral,
		...
		if (exam != null) {
			...
			if (exam.getSmtz_xueya2() != null
				...
				p = new Paragraph("血压:" + exam.getSmtz_xueya() + "/"
						+ exam.getSmtz_xueya2() + "mmHg", fontGeneral);
			} else {
				p = new Paragraph("血压:" + exam.getSmtz_xueya() + "mmHg",
						fontGeneral);
			}
			p.setAlignment(Element.ALIGN_LEFT);
			cellC.addElement(p);
			...
			// 眼睑
			temp = DictionaryUtil.getPublicDictionaryText(pageCode,
					"eyes_yanjian", exam.getEyes_yanjian());
			if (temp.equals("其它")) {
			...
			// 结膜
			temp = DictionaryUtil.getPublicDictionaryText(pageCode,
					"eyes_jiemo", exam.getEyes_jiemo());
			if (temp.equals("其它"))
				temp = exam.getEyes_jiemo0();
			cellC = new PdfPCell();
			...
			// 巩膜
			temp = DictionaryUtil.getPublicDictionaryText(pageCode,
					"eyes_gongmo", exam.getEyes_gongmo());
			if (temp.equals("其它"))
				temp = exam.getEyes_gongmo0();
			cellC = new PdfPCell();
			p = new Paragraph("巩膜:" + temp, fontGeneral);
			p.setAlignment(Element.ALIGN_LEFT);
			cellC.addElement(p);
			cellC.setColspan(2);
			tableContent.addCell(cellC);
			...
			cellC = new PdfPCell();
			p = new Paragraph("角膜:" + temp, fontGeneral);
			p.setAlignment(Element.ALIGN_LEFT);
			cellC.addElement(p);
			cellC.setColspan(2);
			tableContent.addCell(cellC);
			...
			cellC = new PdfPCell();
			p = new Paragraph("眼球:" + temp, fontGeneral);
			p.setAlignment(Element.ALIGN_LEFT);
			cellC.addElement(p);
			cellC.setColspan(2);
			tableContent.addCell(cellC);
			...
			cellC = new PdfPCell();
			p = new Paragraph("瞳孔:" + temp, fontGeneral);
			p.setAlignment(Element.ALIGN_LEFT);
			cellC.addElement(p);
			cellC.setColspan(2);
			tableContent.addCell(cellC);
			...
			cellC = new PdfPCell();
			p = new Paragraph("直接对光反射:" + temp, fontGeneral);
			p.setAlignment(Element.ALIGN_LEFT);
			cellC.addElement(p);
			cellC.setColspan(2);
			tableContent.addCell(cellC);
			...
			cellC = new PdfPCell();
			p = new Paragraph("间接对光反射:" + temp, fontGeneral);
			p.setAlignment(Element.ALIGN_LEFT);
			cellC.addElement(p);
			cellC.setColspan(2);
			tableContent.addCell(cellC);
			...
			// 鼻中隔
			temp = DictionaryUtil.getPublicDictionaryText(pageCode,
					"nose_zhongge", exam.getNose_zhongge());
			cellC = new PdfPCell();
			...
			// 气管位置
			temp = DictionaryUtil.getPublicDictionaryText(pageCode,
					"neck_qiguan", exam.getNeck_qiguan());
			if (temp.equals("其它"))
			...
			// 颈静脉
			temp = DictionaryUtil.getPublicDictionaryText(pageCode,
					"neck_jingmai", exam.getNeck_jingmai());
			if (temp.equals("其它"))
			...
			// 颈动脉搏动
			temp = DictionaryUtil.getPublicDictionaryText(pageCode,
					"neck_dongmai", exam.getNeck_dongmai());
			if (temp.equals("其它"))
			...
			tableContent.addCell(cellC);
			// 呼吸运动
			temp = DictionaryUtil.getPublicDictionaryText(pageCode, "fei_huxi",
					exam.getFei_huxi());
			if (temp.equals("其它"))
			...
			// 心尖搏动
			temp = DictionaryUtil.getPublicDictionaryText(pageCode,
					"xinz_bodong", exam.getXinz_bodong());
			if (temp.equals("其它"))
			...
			// 心音
			temp = DictionaryUtil.getPublicDictionaryText(pageCode,
					"xinz_xinyin", exam.getXinz_xinyin());
			if (temp.equals("其它")) {
			...
			// 叩诊心界
			temp = DictionaryUtil.getPublicDictionaryText(pageCode,
					"xinz_xinjie", exam.getXinz_xinjie());
			if (temp.equals("其它"))
			...
			// Murphy's征
			temp = DictionaryUtil.getPublicDictionaryText(pageCode,
					"fubu_murphy", exam.getFubu_murphy());
			cellC = new PdfPCell();
			...
			// 肝浊音界
			temp = DictionaryUtil.getPublicDictionaryText(pageCode,
					"fubu_ganzhuo", exam.getFubu_ganzhuo());
			cellC = new PdfPCell();
			...
			// 移动性浊音
			temp = DictionaryUtil.getPublicDictionaryText(pageCode,
					"fubu_murphy", exam.getFubu_yidong());
			cellC = new PdfPCell();
			...
			// 腹水
			temp = DictionaryUtil.getPublicDictionaryText(pageCode,
					"fubu_fushui", exam.getFubu_fushui());
			cellC = new PdfPCell();
			...
			// 肾区叩痛
			temp = DictionaryUtil.getPublicDictionaryText(pageCode,
					"fubu_shenkt", exam.getFubu_shenkt());
			cellC = new PdfPCell();
			...
			// 外形
			temp = DictionaryUtil.getPublicDictionaryText(pageCode,
					"jisi_waixing", exam.getJisi_waixing());
			if (temp.equals("其它"))
			...
			// 活动度
			temp = DictionaryUtil.getPublicDictionaryText(pageCode,
					"jisi_huodong", exam.getJisi_huodong());
			cellC = new PdfPCell();
			...
			// 腹壁反射
			temp = DictionaryUtil.getPublicDictionaryText(pageCode,
					"shenjing_fubi", exam.getShenjing_fubi());
			if (temp.equals("其它"))
			...
			// Kernig征
			temp = DictionaryUtil.getPublicDictionaryText(pageCode,
					"shenjing_babinski", exam.getShenjing_kerning());
			if (temp.equals("其它"))
			...
			// 踝阵挛
			temp = DictionaryUtil.getPublicDictionaryText(pageCode,
					"shenjing_huai", exam.getShenjing_huai());
			if (temp.equals("其它"))
			...
			// 扑翼样振颤
			temp = DictionaryUtil.getPublicDictionaryText(pageCode,
					"shenjing_huai", exam.getShenjing_puyi());
			if (temp.equals("其它"))
			...
			// Brudzinski征
			temp = DictionaryUtil.getPublicDictionaryText(pageCode,
					"shenjing_babinski", exam.getShenjing_brudzinski());
			if (temp.equals("其它"))
