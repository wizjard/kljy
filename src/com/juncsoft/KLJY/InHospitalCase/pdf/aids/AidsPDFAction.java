...
public class AidsPDFAction extends DispatchAction {

	private PDFHeader pdfHeader = new PDFHeader();
	private ChiefComplaintPDF chief = new ChiefComplaintPDF();
	private PresentIllnessHistoryByAidsPDF pre = new PresentIllnessHistoryByAidsPDF();
	...
	public ActionForward aidsPDF_Print(ActionMapping mapping,
