...
/**
 * TInHspFeverFeverHistoryIllness entity.
 * 
 * @author MyEclipse Persistence Tools
 */

public class TInHspFeverFeverHistoryIllness implements java.io.Serializable {
	...
	/** default constructor */
	public TInHspFeverFeverHistoryIllness() {
	}

	/** minimal constructor */
	public TInHspFeverFeverHistoryIllness(Long id) {
		this.id = id;
	}

	/** full constructor */
	public TInHspFeverFeverHistoryIllness(Long id, Long caseId, Integer fare,
			Integer fareType, Integer fareXing, String fareXingZdy,
			Integer fareTemperature, String temStart, String temEnd,
			String temMax, String features, String show, Integer weihan,
			Integer hanzhan, Integer hanzhanContinue, Integer sweat,
			Integer daohan, String daohanShowTime, Integer fali,
