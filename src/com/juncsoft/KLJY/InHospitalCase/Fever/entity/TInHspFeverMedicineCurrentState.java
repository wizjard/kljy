...
/**
 * TInHspFeverMedicineCurrentState entity.
 * 
 * @author MyEclipse Persistence Tools
 */

public class TInHspFeverMedicineCurrentState implements java.io.Serializable {
	...
	/** default constructor */
	public TInHspFeverMedicineCurrentState() {
	}

	/** minimal constructor */
	public TInHspFeverMedicineCurrentState(Long id, Long caseId) {
		this.id = id;
		this.caseId = caseId;
	}
	...
	/** full constructor */
	public TInHspFeverMedicineCurrentState(Long id, Long caseId,
			Integer spiritStatu, String spiritStatu0, Integer eatVolume,
			String eatVolume0, Integer sleep, String sleep0, Integer piss,
			String piss0, Integer excrement, String excrement0,
			Integer bodyWeight, String bodyWeightTime,
			Integer bodyWeightTimeUnit, String bodyWeightKg,
			Integer mainSysptomEve, String newSysptom, String otherCurrent,
			String oldContent) {
		this.id = id;
		this.caseId = caseId;
