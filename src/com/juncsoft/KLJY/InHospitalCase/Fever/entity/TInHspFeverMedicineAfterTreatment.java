...
/**
 * TInHspFeverMedicineAfterTreatment entity.
 * 
 * @author MyEclipse Persistence Tools
 */

public class TInHspFeverMedicineAfterTreatment implements java.io.Serializable {
	...
	/** default constructor */
	public TInHspFeverMedicineAfterTreatment() {
	}

	/** minimal constructor */
	public TInHspFeverMedicineAfterTreatment(Long id, Long caseId) {
		this.id = id;
		this.caseId = caseId;
	}
